...
Project proposals MUST align with the Constitution (v3.0.1):
...
- UX Consistency: Use shadcn/ui + Tailwind; SWR tuple keys and proxy routes; consistent patterns (Zustand/TanStack).
...
---
*Based on Constitution v3.0.1 - See `/memory/constitution.md`*
